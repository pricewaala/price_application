import 'bloc/setting_three_bloc.dart';
import 'models/setting_three_model.dart';
...
class SettingThreeScreen extends StatelessWidget {
  const SettingThreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<SettingThreeBloc>(
      create: (context) => SettingThreeBloc(SettingThreeState(
        settingThreeModelObj: SettingThreeModel(),
      ))
        ..add(SettingThreeInitialEvent()),
      child: SettingThreeScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SettingThreeBloc, SettingThreeState>(
          ...
          child: Scaffold(
            ...
            body: SizedBox(
              ...
              child: SingleChildScrollView(
                ...
                child: _buildSettingThree(context),
              ),
            ),
          ),
        );
  ...
  /// Section Widget
  Widget _buildSettingThree(BuildContext context) {
    return Padding(
