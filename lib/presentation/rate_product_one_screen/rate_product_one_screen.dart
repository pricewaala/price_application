import 'bloc/rate_product_one_bloc.dart';
import 'models/rate_product_one_model.dart';
...
class RateProductOneScreen extends StatelessWidget {
  const RateProductOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<RateProductOneBloc>(
      create: (context) => RateProductOneBloc(RateProductOneState(
        rateProductOneModelObj: RateProductOneModel(),
      ))
        ..add(RateProductOneInitialEvent()),
      child: RateProductOneScreen(),
    );
  }
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Text(
                "msg_what_is_your_opinion".tr,
                style: CustomTextStyles.titleSmallPoppinsGray90009,
              ),
              ...
              Padding(
                ...
                child: BlocSelector<RateProductOneBloc, RateProductOneState,
                    TextEditingController?>(
                  selector: (state) => state.writeAnythingController,
                  builder: (context, writeAnythingController) {
                    return CustomTextFormField(
                      controller: writeAnythingController,
