import 'bloc/order_info_one_bloc.dart';
import 'models/order_info_one_model.dart';
...
class OrderInfoOneScreen extends StatelessWidget {
  const OrderInfoOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<OrderInfoOneBloc>(
      create: (context) => OrderInfoOneBloc(OrderInfoOneState(
        orderInfoOneModelObj: OrderInfoOneModel(),
      ))
        ..add(OrderInfoOneInitialEvent()),
      child: OrderInfoOneScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<OrderInfoOneBloc, OrderInfoOneState>(
        ...
        children: [
          ...
          Padding(
            ...
            child: _buildTrackingNumber(
              ...
              ikNumber: "msg_sbi_building_software".tr,
            ),
          ),
        ],
      ),
