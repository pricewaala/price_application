import 'bloc/profile_setting_two_bloc.dart';
import 'models/profile_setting_two_model.dart';
...
class ProfileSettingTwoScreen extends StatelessWidget {
  const ProfileSettingTwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileSettingTwoBloc>(
      create: (context) => ProfileSettingTwoBloc(ProfileSettingTwoState(
        profileSettingTwoModelObj: ProfileSettingTwoModel(),
      ))
        ..add(ProfileSettingTwoInitialEvent()),
      child: ProfileSettingTwoScreen(),
    );
  }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildChangeAvatarFrame(context),
  ...
  /// Section Widget
  Widget _buildChangeAvatarFrame(BuildContext context) {
    return Row(
      ...
      children: [
        Column(
          ...
          children: [
            ...
            BlocSelector<ProfileSettingTwoBloc, ProfileSettingTwoState,
