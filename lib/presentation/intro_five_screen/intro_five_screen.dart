import 'bloc/intro_five_bloc.dart';
import 'models/intro_five_model.dart';
...
class IntroFiveScreen extends StatelessWidget {
  const IntroFiveScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<IntroFiveBloc>(
      create: (context) => IntroFiveBloc(IntroFiveState(
        introFiveModelObj: IntroFiveModel(),
      ))
        ..add(IntroFiveInitialEvent()),
      child: IntroFiveScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<IntroFiveBloc, IntroFiveState>(
