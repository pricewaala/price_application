...
class TrackOrderScreen extends StatelessWidget {
            ...
            body: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTrackingNumberView(context),
                  SizedBox(height: 6.v),
                  Container(
                    height: 4.adaptSize,
                    width: 4.adaptSize,
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 2.h),
                    child: _buildCheckmarkView(
                      context,
                      text: "msg_parcel_is_in_transit".tr,
                      month: "lbl_13_may_07_00".tr,
                    ),
                  ),
                  SizedBox(height: 6.v),
                  Container(
                  ...
                  SizedBox(height: 6.v),
                  _buildSenderShippedView(context),
                  SizedBox(height: 6.v),
                  Container(
                    height: 4.adaptSize,
                    width: 4.adaptSize,
                  ...
                  SizedBox(height: 6.v),
                  _buildSenderPreparingView(context),
  ...
  /// Section Widget
  Widget _buildTrackingNumberView(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
      child: Row(
        children: [
  ...
  /// Section Widget
  Widget _buildCheckmarkView1(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
      child: Row(
        children: [
  ...
  /// Section Widget
  Widget _buildCheckmarkView2(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
      child: Row(
  ...
  /// Section Widget
  Widget _buildSenderShippedView(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Padding(
            ...
            child: _buildCheckmarkView(
              context,
              text: "msg_sender_has_shipped".tr,
              month: "lbl_12_may_14_25".tr,
            ),
          ),
          SizedBox(height: 6.v),
          Container(
  ...
  /// Section Widget
  Widget _buildSenderPreparingView(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
