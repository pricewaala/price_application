import 'bloc/sidebar_home_bloc.dart';
import 'package:flutter/material.dart';
import 'package:price_s_application2/core/app_export.dart';
import 'package:price_s_application2/widgets/custom_text_form_field.dart';

// ignore_for_file: must_be_immutable
class SidebarHomeDraweritem extends StatelessWidget {
  const SidebarHomeDraweritem({Key? key})
      : super(
          key: key,
        );
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.max,
                children: [
                  BlocSelector<SidebarHomeBloc, SidebarHomeState,
