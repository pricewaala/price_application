import 'bloc/order_info_two_bloc.dart';
import 'models/order_info_two_model.dart';
...
class OrderInfoTwoScreen extends StatelessWidget {
  const OrderInfoTwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<OrderInfoTwoBloc>(
      create: (context) => OrderInfoTwoBloc(OrderInfoTwoState(
        orderInfoTwoModelObj: OrderInfoTwoModel(),
      ))
        ..add(OrderInfoTwoInitialEvent()),
      child: OrderInfoTwoScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<OrderInfoTwoBloc, OrderInfoTwoState>(
