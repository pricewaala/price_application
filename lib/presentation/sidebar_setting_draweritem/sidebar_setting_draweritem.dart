import 'bloc/sidebar_setting_bloc.dart';
import 'package:flutter/material.dart';
import 'package:price_s_application2/core/app_export.dart';
import 'package:price_s_application2/widgets/custom_search_view.dart';

// ignore_for_file: must_be_immutable
class SidebarSettingDraweritem extends StatelessWidget {
  const SidebarSettingDraweritem({Key? key})
      : super(
          key: key,
        );
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: BlocSelector<SidebarSettingBloc, SidebarSettingState,
