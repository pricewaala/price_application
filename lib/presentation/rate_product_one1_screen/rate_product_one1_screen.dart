import 'bloc/rate_product_one1_bloc.dart';
import 'models/rate_product_one1_model.dart';
...
class RateProductOne1Screen extends StatelessWidget {
  const RateProductOne1Screen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<RateProductOne1Bloc>(
      create: (context) => RateProductOne1Bloc(RateProductOne1State(
        rateProductOne1ModelObj: RateProductOne1Model(),
      ))
        ..add(RateProductOne1InitialEvent()),
      child: RateProductOne1Screen(),
    );
  }
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: BlocSelector<RateProductOne1Bloc, RateProductOne1State,
