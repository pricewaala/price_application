import 'bloc/password_changed_one_bloc.dart';
import 'models/password_changed_one_model.dart';
import 'package:flutter/material.dart';
import 'package:price_s_application2/core/app_export.dart';
import 'package:price_s_application2/widgets/custom_elevated_button.dart';

// ignore_for_file: must_be_immutable
class PasswordChangedOneBottomsheet extends StatelessWidget {
  const PasswordChangedOneBottomsheet({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<PasswordChangedOneBloc>(
      create: (context) => PasswordChangedOneBloc(PasswordChangedOneState(
        passwordChangedOneModelObj: PasswordChangedOneModel(),
      ))
        ..add(PasswordChangedOneInitialEvent()),
      child: PasswordChangedOneBottomsheet(),
    );
  }
