...
class SettingScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SettingBloc>(
      create: (context) => SettingBloc(SettingState(
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                CustomImageView(
                  imagePath: ImageConstant.imgIconsGlobeLineBlueGray200,
                  height: 24.adaptSize,
                  width: 24.adaptSize,
                ),
                Padding(
          ...
          Padding(
            ...
            child: _buildPrivacyPolicy(
              context,
              image: ImageConstant.imgBellDuotoneBlueGray200,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                CustomImageView(
                  imagePath: ImageConstant.imgIconsMedicalChartLineBlueGray200,
                  height: 24.adaptSize,
                  width: 24.adaptSize,
                ),
                Padding(
          ...
          Padding(
            ...
            child: _buildPrivacyPolicy(
              context,
              image: ImageConstant.imgIconsInfoCircleLineBlueGray200,
          ...
          Padding(
            ...
            child: Row(
              children: [
                CustomImageView(
                  imagePath: ImageConstant.imgIconsLocationArrowLineBlueGray200,
                  height: 22.adaptSize,
                  width: 22.adaptSize,
                ),
                Padding(
