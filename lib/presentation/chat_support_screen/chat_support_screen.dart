import 'bloc/chat_support_bloc.dart';
...
class ChatSupportScreen extends StatelessWidget {
  const ChatSupportScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ChatSupportBloc>(
      create: (context) => ChatSupportBloc(ChatSupportState(
        chatSupportModelObj: ChatSupportModel(),
      ))
        ..add(ChatSupportInitialEvent()),
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: _buildChatSupport(context),
                ),
              ),
            ],
          ),
  ...
  /// Section Widget
  Widget _buildChatSupport(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
        left: 16.h,
        bottom: 5.v,
  ...
  Widget _buildMessage(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: BlocSelector<ChatSupportBloc, ChatSupportState,
