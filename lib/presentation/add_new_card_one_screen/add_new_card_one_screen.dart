import 'bloc/add_new_card_one_bloc.dart';
import 'models/add_new_card_one_model.dart';
import 'package:flutter/material.dart';
import 'package:price_s_application2/core/app_export.dart';
import 'package:price_s_application2/widgets/app_bar/appbar_leading_iconbutton.dart';
import 'package:price_s_application2/widgets/app_bar/appbar_subtitle_six.dart';
...
class AddNewCardOneScreen extends StatelessWidget {
  const AddNewCardOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<AddNewCardOneBloc>(
      create: (context) => AddNewCardOneBloc(AddNewCardOneState(
        addNewCardOneModelObj: AddNewCardOneModel(),
      ))
        ..add(AddNewCardOneInitialEvent()),
      child: AddNewCardOneScreen(),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "lbl_card_number".tr,
              style: CustomTextStyles.bodySmallPoppinsBluegray40099,
            ),
            SizedBox(height: 11.v),
            BlocSelector<AddNewCardOneBloc, AddNewCardOneState,
  ...
  /// Section Widget
  Widget _buildExpires(BuildContext context) {
    return Expanded(
      child: Padding(
        padding: EdgeInsets.only(
          top: 1.v,
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "lbl_03_23".tr,
                      style: CustomTextStyles.bodyMediumPoppinsBluegray90001,
                    ),
                  ),
                ],
              ),
  ...
  /// Section Widget
  Widget _buildCvv1(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 30.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          _buildExpires(context),
          _buildCvv(context),
        ],
      ),
    );
