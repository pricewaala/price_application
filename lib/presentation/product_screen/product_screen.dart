import '../product_screen/widgets/view1_item_widget.dart';
...
class ProductScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<ProductBloc>(
      create: (context) => ProductBloc(ProductState(
                    ...
                    BlocBuilder<ProductBloc, ProductState>(
                      builder: (context, state) {
                        return CarouselSlider.builder(
                          ...
                          itemCount:
                              state.productModelObj?.view1ItemList.length ?? 0,
                          itemBuilder: (context, index, realIndex) {
                            View1ItemModel model =
                                state.productModelObj?.view1ItemList[index] ??
                                    View1ItemModel();
                        ...
                        builder: (context, state) {
                          return SizedBox(
                            ...
                            child: AnimatedSmoothIndicator(
                              ...
                              count:
                                  state.productModelObj?.view1ItemList.length ??
                                      0,
