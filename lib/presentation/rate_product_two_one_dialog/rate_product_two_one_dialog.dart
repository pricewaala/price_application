import 'bloc/rate_product_two_one_bloc.dart';
import 'models/rate_product_two_one_model.dart';
import 'package:flutter/material.dart';
import 'package:price_s_application2/core/app_export.dart';
import 'package:price_s_application2/widgets/custom_elevated_button.dart';

// ignore_for_file: must_be_immutable
class RateProductTwoOneDialog extends StatelessWidget {
  const RateProductTwoOneDialog({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<RateProductTwoOneBloc>(
      create: (context) => RateProductTwoOneBloc(RateProductTwoOneState(
        rateProductTwoOneModelObj: RateProductTwoOneModel(),
      ))
        ..add(RateProductTwoOneInitialEvent()),
      child: RateProductTwoOneDialog(),
    );
  }
