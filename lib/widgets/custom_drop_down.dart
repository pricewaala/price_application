...
class CustomDropDown extends StatelessWidget {
  ...
  Widget get dropDownWidget => SizedBox(
        ...
        child: DropdownButtonFormField<SelectionPopupModel>(
          ...
          icon: icon,
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumBluegray90004,
          items: items?.map((SelectionPopupModel item) {
            return DropdownMenuItem<SelectionPopupModel>(
              ...
              child: Text(
                ...
                style: hintStyle ?? CustomTextStyles.bodyMediumGray5006,
              ),
            );
          }).toList(),
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumGray5006,
        prefixIcon: prefix,
        ...
        focusedBorder: borderDecoration ??
            OutlineInputBorder(
              ...
              borderSide: BorderSide(
                color: appTheme.blueGray90004.withOpacity(0.15),
                width: 2,
              ),
            ),
      );
...
extension DropDownStyleHelper on CustomDropDown {
  static OutlineInputBorder get outlineBlueGrayTL19 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(19.h),
        borderSide: BorderSide(
          color: appTheme.blueGray90004.withOpacity(0.15),
          width: 1,
